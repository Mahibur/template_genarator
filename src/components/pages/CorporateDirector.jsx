...
const CorporateDirector = () => {
  ...
  return (
    <div>
      <h1 className="bg-[#EEE406] text-3xl font-bold text-center py-6">
      Corporate Director
        </h1>
      <Container>
        ...
        {croppedImage && (
          <div className="py-10">
            ...
            <div ref={divRef} className={`relative bg-[url(/2.jpg)] bg-cover bg-no-repeat object-cover  bg-center w-[1024px] py-[512px]`}>
