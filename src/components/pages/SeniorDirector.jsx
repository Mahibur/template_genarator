...
const SeniorDirector = () => {
  ...
  return (
    <div>
      <h1 className="bg-[#54FD00] text-3xl font-bold text-center py-6">
      SeniorDirector
        </h1>
      <Container>
        ...
        {croppedImage && (
          <div className="py-10">
            ...
            <div ref={divRef} className={`relative bg-[url(/18.jpg)] bg-cover bg-no-repeat object-cover  bg-center w-[1024px] py-[512px]`}>
