...
const GlobalEnterpreneurCruise = () => {
  ...
  return (
    <div>
      <h1 className="bg-[#0082E5] text-white text-3xl font-bold text-center py-6">
      Global Enterpreneur
        </h1>
      <Container>
        ...
        {croppedImage && (
          <div className="py-10">
            ...
            <div ref={divRef} className={`relative bg-[url(/15.jpg)] bg-cover bg-no-repeat object-cover  bg-center w-[1024px] py-[512px]`}>
              <p className="absolute left-1/2 bottom-[10%] translate-x-[-50%] text-4xl font-bold italic capitalize text-[#e7f7f4]">{name}</p>
              <img className="absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-31%] block w-76 rounded-[50%]" src={croppedImage} alt="Cropped" />
            </div>
