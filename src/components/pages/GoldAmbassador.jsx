...
const GoldAmbassador = () => {
  ...
  return (
    <div>
      <h1 className="bg-[#D39332] text-3xl font-bold text-center py-6">
      Gold Ambassador
        </h1>
      <Container>
        ...
        {croppedImage && (
          <div className="py-10">
            ...
            <div ref={divRef} className={`relative bg-[url(/9.jpg)] bg-cover bg-no-repeat object-cover  bg-center w-[1024px] py-[512px]`}>
              <p className="absolute left-1/2 bottom-[10%] translate-x-[-50%] text-4xl font-bold italic capitalize text-[#e7f7f4]">{name}</p>
              <img className="absolute top-1/2 left-1/2 translate-x-[-53%] translate-y-[-24%] block w-70.5 rounded-[50%]" src={croppedImage} alt="Cropped" />
            </div>
