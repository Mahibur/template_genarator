...
const InternationalDirector = () => {
  ...
  return (
    <div>
      <h1 className="bg-[#04F200] text-3xl font-bold text-center py-6">
      ...
      <Container>
        ...
        {croppedImage && (
          <div className="py-10">
            ...
            <div ref={divRef} className={`relative bg-[url(/6.jpg)] bg-cover bg-no-repeat object-cover  bg-center w-[1024px] py-[512px]`}>
